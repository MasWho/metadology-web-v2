...
const CarouselItemCaption = (props: { items: { caption: string }[] }) => {
  ...
  return (
    <div className='absolute w-[100vw] mt-[10px]'>
...
const CarouselNav = (props: { items: { caption: string }[] }) => {
  ...
  return (
    <div className="relative w-[100vw] mt-[45px] desktop:left-[72vw] tablet:left-[75vw] tablet:mt-[5px] flex justify-center gap-10 tablet:gap-3 tablet:w-[10%]">
      <ChevronArrow
        direction="left"
        size="30px"
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative origin-left w-[100%] h-[100%]"
      >
        <Image
          src={item.url}
